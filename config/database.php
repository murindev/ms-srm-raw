...
//            'use_mongo_id' => false,
        ...
        'mongoMetrika' => [
            'driver'   => 'mongodb',
            'host'     => env('METRIKA_DB_HOST'),/*, 'localhost'*/
            'port'     => env('METRIKA_DB_PORT', 27017),
            'database' => env('METRIKA_DB_DATABASE'),
            'username' => env('METRIKA_DB_USERNAME'),
            'password' => env('METRIKA_DB_PASSWORD'),
//            'use_mongo_id' => false,
            'options' => [
                'db' => 'admin', // Sets the authentication database required by mongo 3
                //['replicaSet' => 'replicaSetName'], // Connect to multiple servers or replica sets
