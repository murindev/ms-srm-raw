...
<script>
    ...
    let regionsArray = @json($regionsArray);
                    ...
                    if(dadataAddress.data.geo_lat && dadataAddress.data.geo_lon){
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'flat': regionsArray[dadataAddress.data.region].center_lat,
                                'flon': regionsArray[dadataAddress.data.region].center_lon,
                                "_token": "{{ csrf_token() }}"
                            }
                        }).success(function (data) {
