    ...
    <div class="letter">
        ...
        <div class="letter-wrapper" style="font-family:Verdana, Geneva, sans-serif;" ref="letter_sesteam">
            ...
            <table class="sesteam_ru" background="https://sesteam.ru/img/bg/bronya.png" border="0" cellpadding="0"
                ...
                <tr>
                    <td colspan="2"
                        style="text-align: justify; text-indent: 20px; padding: 15px 40px; color: white; font-size: 16px;" v-html="content.introText.model">
                    ...
                    <td colspan="2" style="padding: 0 20px;">
                        <table border="1" cellpadding="0" cellspacing="0"
                            ...
                            <tr style="border-bottom: 1px solid white;
                                ">
                                <th v-for="(th,key) in content.table.thead" v-if="key !== 'chb'"
                            ...
                            <tbody>
                            <tr v-for="(tr,trKey) in content.table.tbody" v-if="tr.service_price">
                                <td v-for="(td,tdKey) in content.table.thead" v-if="tdKey !== 'chb'" style="padding: 10px 0; text-align: center;">
                                    <template v-if="tdKey === 'chb'"></template>
                ...
                <tr>
                    <td colspan="2"
                       ...
                       <span style="text-indent: 20px; display: block;">{{content.manager.text}} {{content.manager.name}}</span> <br/>
...
<script>
    ...
    export default {
        ...
        methods:{
            send(){
                bus.$emit('send_letter',this.$refs.letter_sesteam.innerHTML)
            }
        },
        // created() {
        //     console.log('dfdfdf',this.$props.content);
        // }
    }
</script>
