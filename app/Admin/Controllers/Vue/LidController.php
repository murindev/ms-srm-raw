...
class LidController extends Controller
{
  ...
  +"formatted": "2019-05-30 00:00:00"
    ...
    {
//        <script src='/js/new/lids.list.js'></script>
        return $content
            ->header('Index')
            ->description('description')
            ->body("<div id='lidsList'><lids-list manager='".$this->manager()."'></lids-list></div>");
    }
...
//        })->sortable();
        ...
        $grid->actions(function ($actions) {
            ...
            $actions->disableView();
            // prepend an action.
            $actions->prepend('<a href="/layout/lid/' .$actions->getKey('id'). '/edit"><i class="fa fa-paper-plane"> Редактировать</i></a>');
        });
