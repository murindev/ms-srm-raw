...
class MethodController extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->cost('Стоимость за')->sortable()->editable();
        $grid->unit('ед.')->select(Square::all()->pluck('name','id'))->sortable();
    ...
    protected function form()
    {
        ...
        $form->display('id');
        $form->text('name','');
        $form->text('cost','Стоимость');
        $form->select('unit','Единица ищмерения')->options(Square::all()->pluck('name','id'));
